    ...
    <div>
      <div className="mx-auto max-w-7xl">
        ...
        <div
          ...
          style={{ borderColor: "rgba(133,43,175,0.08)" }}
        >
              ...
              <table className="min-w-full text-sm text-left text-gray-700">
                <thead>
                  <tr style={{ background: "linear-gradient(135deg, rgba(133,43,175,0.06) 0%, rgba(252,63,120,0.03) 100%)" }}>
                    {["SKU", "Attributes", "MRP", "Sale Price", "Stock", "Visibility"].map((h) => (
                      <th key={h} className="px-4 py-3 text-xs font-bold tracking-wider text-gray-500 uppercase">{h}</th>
                    ))}
                  </tr>
                </thead>
        ...
        <section className="p-5 mt-4 border border-gray-100 vendor-section-card bg-gray-50/50 rounded-2xl">
          ...
          <div className="flex flex-wrap gap-3">
            {product.productImages && product.productImages.length > 0 ? (
              ...
              <div className="flex items-center justify-center w-48 h-48 text-sm font-medium text-gray-400 bg-gray-100 rounded-2xl" style={{ border: "1px dashed rgba(133,43,175,0.2)" }}>
                No cover image
              </div>
            )}
          </div>
