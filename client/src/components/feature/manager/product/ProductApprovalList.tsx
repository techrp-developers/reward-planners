          ...
          <table className="min-w-full divide-y divide-gray-100">
            <thead style={{ background: "linear-gradient(135deg, #fdf8ff 0%, #fff5f8 100%)" }}>
              <tr>
                <th
                  ...
                  className="px-4 py-4 text-xs font-bold text-gray-500 uppercase cursor-pointer tracking-wider"
                >
            ...
            <tbody className="divide-y divide-gray-50 bg-white">
              {products.map((product) => (
                <tr key={product.product_id} className="hover:bg-purple-50/30 transition-colors">
                  {/* NEW: Product ID cell */}
                      ...
                      {product.status === "pending" && (
                        <>
                          ...
                          <button
                            ...
                            className="w-8 h-8 inline-flex items-center justify-center rounded-lg bg-green-50 border border-green-200 text-green-600 hover:bg-green-600 hover:text-white hover:border-green-600 transition-all shadow-sm cursor-pointer"
                            title="Approve"
                          >
                          ...
                          <button
                            ...
                            className="w-8 h-8 inline-flex items-center justify-center rounded-lg bg-red-50 border border-red-200 text-red-500 hover:bg-red-500 hover:text-white hover:border-red-500 transition-all shadow-sm cursor-pointer"
                            title="Reject"
                          >
