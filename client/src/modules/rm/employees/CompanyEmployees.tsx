...
interface Employee { id: number; name: string; email: string | null; phone: string | null; department: string | null; role: string | null; date_of_joining: string | null; dob: string | null; address1: string | null; address2: string | null; reporting_manager: string | null; ctc: number | null; status: number; customer_id: number | null; customer_is_verified: number | null; device_platform: "android" | "ios" | null; device_name: string | null }
