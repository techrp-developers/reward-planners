...
export default function WarehouseNavbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 flex flex-col h-full bg-white border-r shadow w-60">
      {/* LOGO */}
      <div className="p-6 border-b">
        <div className="flex items-center gap-3">
          <div
            className="flex items-center justify-center w-10 h-10 font-bold text-white rounded-xl"
          ...
          item.isDropdown ? (
            <div key={item.label}>
              <button
                ...
                className="flex justify-between w-full px-4 py-3 font-semibold text-gray-700 rounded-xl hover:bg-gray-50"
              >
                <div className="flex items-center gap-3">
                  <item.Icon />
      ...
      <div className="p-4 border-t">
        ...
        >
          <div className="flex items-center justify-center w-10 h-10 font-bold text-purple-700 bg-purple-100 rounded-full">
