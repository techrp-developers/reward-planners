            ...
            >
              {item.type === "dropdown" ? (
                ...
                >
                  ...
                  {!!item.badgeCount && (
                    <span
                      className={`ml-auto flex items-center justify-center min-w-[20px] h-5 px-1.5 text-[10px] font-bold rounded-full ${
                        isItemActive ? "bg-white/25 text-white" : "bg-red-500 text-white"
                      }`}
                    >
